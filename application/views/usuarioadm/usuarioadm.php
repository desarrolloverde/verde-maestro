			...
			<table class="table table-bordered">
						...
						foreach ($datos as $row) { ?>
							<tr>
										...
										<td><a href='usuarioadm/editarDisplay/<?php echo $row->us_id_usuario_a_pk; ?>' title='Editar'><span class='glyphicon glyphicon-pencil'></span></a>
											<a href='usuarioadm/borrarUsuarioadm/<?php echo $row->us_id_usuario_a_pk; ?>' title='Eliminar'><span class='glyphicon glyphicon-trash'></span></a>
										</td>
								</tr>
						<?php }						?>
						<tr>
  							<td colspan="6" align="center">
  								<button type="button" class="btn btn-default navbar-btn" onclick = "location='<?php echo base_url(); ?>index.php/usuarioadm/registroDisplay'">Nuevo registro</button>
