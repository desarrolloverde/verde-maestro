...
class Registro extends CI_Controller {
	...
	public function registroDisplay()
	{
		...
		$data->contenido = "usuario/registro";
		$this->load->view('login',$data);
	}
	public function registroInsertar(){
        ...
        else
        {
        	//if (isset($this->input->post)) {
	        	...
	        	$ejecucion=$this->Model_Usuario->insertUsuario($password,$nombres,$apellidos,$email,$fenacimiento);
				//echo $ejecucion; 
				if ($ejecucion) { 
					$this->session->set_flashdata("mensaje_exito","El usuario ha sido ingresado");
